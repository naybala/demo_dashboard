...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @return \BasicDashboard\Foundations\Domain\Users\User|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \BasicDashboard\Foundations\Domain\Users\User|false
         * @static
         */
         ...
         *
         * @return \BasicDashboard\Foundations\Domain\Users\User
         * @static
         */
    ...
    class Response {
         ...
         * @static
         */
        public static function redirectBackWithError($message)
        {
            return \Illuminate\Routing\ResponseFactory::redirectBackWithError($message);
        }
         ...
         * @static
         */
        public static function successAjaxResponse($message, $data)
        {
            return \Illuminate\Routing\ResponseFactory::successAjaxResponse($message, $data);
        }
         ...
         * @static
         */
        public static function notFoundAjaxRequest($message)
        {
            return \Illuminate\Routing\ResponseFactory::notFoundAjaxRequest($message);
        }
         ...
         * @static
         */
        public static function failAjaxResponse($message)
        {
            return \Illuminate\Routing\ResponseFactory::failAjaxResponse($message);
        }
         ...
         * @static
         */
        public static function sendAuthFailedResponse($message, $data = null)
        {
            return \Illuminate\Routing\ResponseFactory::sendAuthFailedResponse($message, $data);
        }
         ...
         * @static
         */
        public static function sendSuccessResponse($message, $data = null)
        {
            return \Illuminate\Routing\ResponseFactory::sendSuccessResponse($message, $data);
        }
        ...
        {
            return \Illuminate\Routing\ResponseFactory::sendErrorResponse($message);
        }
...
namespace Illuminate\Filesystem {
    ...
    class FilesystemAdapter {
         ...
         * @static
         */
        public static function uploadFileToCloud($disk, $file, $path, $privacy, $columnKey)
        {
            return \Illuminate\Filesystem\FilesystemAdapter::uploadFileToCloud($disk, $file, $path, $privacy, $columnKey);
        }
         ...
         * @static
         */
        public static function uploadFileToLocal($file, $path, $columnKey)
        {
            return \Illuminate\Filesystem\FilesystemAdapter::uploadFileToLocal($file, $path, $columnKey);
        }

        /**
         * @see \App\Providers\StorageMacroProvider::boot()
         * @param mixed $disk
         * @param mixed $oldFileUrl
         * @param mixed $newFile
         * @param mixed $path
         * @param mixed $privacy
         * @param mixed $columnKey
         ...
         * @static
         */
        public static function updateFileFromCloud($disk, $oldFileUrl, $newFile, $path, $privacy, $columnKey)
        {
            return \Illuminate\Filesystem\FilesystemAdapter::updateFileFromCloud($disk, $oldFileUrl, $newFile, $path, $privacy, $columnKey);
        }
         ...
         * @static
         */
        public static function updateFileFromLocal($oldFileUrl, $newFile, $columnKey, $path)
        {
            return \Illuminate\Filesystem\FilesystemAdapter::updateFileFromLocal($oldFileUrl, $newFile, $columnKey, $path);
        }
         ...
         * @static
         */
        public static function deletFileFromLocal($fileUrl)
        {
            \Illuminate\Filesystem\FilesystemAdapter::deletFileFromLocal($fileUrl);
        }
         ...
         * @static
         */
        public static function deleteFileFromCloud($disk, $fileUrl)
        {
            \Illuminate\Filesystem\FilesystemAdapter::deleteFileFromCloud($disk, $fileUrl);
        }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
        ...
        /**
         * @see \App\Providers\BuilderMacroProvider::boot()
         * @param string $column
         * @param mixed|null $value
         * @static
         */
        public static function searchFilter($column, $value)
        {
            return \Illuminate\Database\Eloquent\Builder::searchFilter($column, $value);
        }
         ...
         * @static
         */
        public static function andSearchFilter($column, $value)
        {
            return \Illuminate\Database\Eloquent\Builder::andSearchFilter($column, $value);
        }
         ...
         * @static
         */
        public static function searchLikeFilter($column, $value)
        {
            return \Illuminate\Database\Eloquent\Builder::searchLikeFilter($column, $value);
        }
