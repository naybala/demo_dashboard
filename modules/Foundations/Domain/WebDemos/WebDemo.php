...
namespace BasicDashboard\Foundations\Domain\WebDemos;
...
/**
 *
 * A WebDemo is gives a basic way to do that using Eloquent ORM where each table incorporates to interact with it.
