...
namespace BasicDashboard\Foundations\Domain\Demos;
...
/**
 *
 * A Demo is gives a basic way to do that using Eloquent ORM where each table incorporates to interact with it.
