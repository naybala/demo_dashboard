...
const form = useForm({
  student_info: props.student?.student_info || "",
...
<template>
  <Head
    :title="
      is_editing
        ? __('school.edit_student', 'Edit Student')
        : __('school.add_student', 'Add Student')
    "
  />
  ...
  <AdminLayout>
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        >
          <div
            class="p-8 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center"
          >
            <div>
              ...
              <p class="text-sm text-gray-500 mt-1 dark:text-gray-400">
                Create a new student profile with basic, contact and academic
                details.
              </p>
            </div>
              ...
              <div class="flex flex-col md:flex-row gap-12">
                <div class="flex-1 space-y-6">
                  <div>
                    <InputLabel
                      for="student_info"
                      value="Choose student Info"
                    />
                    <SearchableSelect
                      id="student_info"
                      v-model="form.student_info"
                      :options="[
                        { id: 'Public School', label: 'Public School' },
                        { id: 'Private School', label: 'Private School' },
                      ]"
                      placeholder="Select..."
                      class="mt-1 block w-full"
                      :error="form.errors.student_info"
                    />
                    <InputError
                      :message="form.errors.student_info"
                      class="mt-2"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <InputError
                      :message="form.errors.registration_date"
                      class="mt-2"
                    />
                  </div>
                </div>
                ...
                <div class="flex-1 md:max-w-xs space-y-6">
                  <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                      Use school ID format, e.g. STU-2001
                    </p>
                    <InputError
                      :message="form.errors.student_code"
                      class="mt-2"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div class="mt-2 flex gap-3">
                      <label class="cursor-pointer">
                        ...
                        />
                        <div
                          class="px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-600 peer-checked:bg-blue-600 peer-checked:text-white transition-colors"
                        >
                          Male
                        </div>
                      </label>
            ...
            >
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      class="mt-1 block w-full border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                      placeholder="Address"
                    ></textarea>
                  </div>
                </div>
              ...
              <section>
                <div class="mb-6">
                  ...
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    Assign class, section and section for this student.
                  </p>
                </div>
            ...
            >
              <section>
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    <InputLabel
                      for="father_qualification"
                      value="Father's Qualification"
                    />
                    <TextInput
                      id="father_qualification"
                      v-model="form.father_qualification"
                      class="mt-1 block w-full bg-gray-50"
              ...
              <section>
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    <InputLabel
                      for="mother_qualification"
                      value="Mother's Qualification"
                    />
                    <TextInput
                      id="mother_qualification"
                      v-model="form.mother_qualification"
                      class="mt-1 block w-full bg-gray-50"
                      placeholder="Qualification"
                    />
                  </div>
            ...
            >
              <section>
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    <InputLabel
                      for="guardian_qualification"
                      value="Guardian's Qualification"
                    />
                    <TextInput
                      id="guardian_qualification"
                      v-model="form.guardian_qualification"
                      class="mt-1 block w-full bg-gray-50"
                      placeholder="Qualification"
                    />
                  </div>
                  ...
                  <div>
                    <InputLabel
                      for="guardian_email"
                      value="Guardian's Email Address"
                    />
                    <TextInput
                      id="guardian_email"
                      type="email"
