...
<x-form.control>
    ...
    "searchWrapperClasses": "py-1 px-4 w-full text-sm text-gray-800 cursor-pointer hover:bg-gray-100 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 text-md dark:bg-gray-700 dark:text-gray-200 tracking-wider",
    "placeholder": "Select",
