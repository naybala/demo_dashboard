...
<x-form.control>
    ...
    <div class="relative">
        ...
        <input datepicker datepicker-buttons datepicker-autoselect-today datepicker-format="yyyy-mm-dd" value="{{ $value }}"
            ...
            class="bg-[var(--form-input-bg)] border border-[var(--form-input-border)] text-[var(--form-input-text)] placeholder-[var(--form-input-placeholder)] text-sm rounded-lg focus:ring-1 focus:ring-[var(--color-theme)] focus:border-[var(--color-theme)] focus:outline-none block w-full ps-10 p-2" 
